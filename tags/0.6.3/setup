...
defaultLanguages = ['c', 'c++', 'd', 'python', 'lpunit']

compiledLanguages = ['c', 'c++', 'd', 'lpunit']

headerExtensions = { 'c': ['h'] , 'c++': ['h', 'hpp'], 'd': [], 'lpunit': ['h', 'hpp'] }
...
class SetupHandler:
    ...
    def SetupPlatformSpecificOptions(self):
        ...
        if self.platform == 'linux':
           ...
           defaultCompiler = { 'c++': 'g++', 'd': 'gdc', 'c': 'gcc', 'lpunit': 'lpmaketest' }
           defaultLinker = { 'c++': 'g++', 'd': 'gdc', 'c': 'gcc', 'lpunit': 'g++' }
